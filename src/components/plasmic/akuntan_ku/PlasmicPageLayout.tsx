...
import sty from "./PlasmicPageLayout.module.css"; // plasmic-import: R3z5KRAspWPt/css

import IconIcon from "./icons/PlasmicIcon__Icon"; // plasmic-import: nuEp3nrMc__M/icon
import Icon2Icon from "./icons/PlasmicIcon__Icon2"; // plasmic-import: 2Moq9gqPm4fn/icon
...
function PlasmicPageLayout__RenderFunc(props: {
  ...
  return (
    <RichLayout
      ...
      logoElement={
        <Icon2Icon
          className={classNames(projectcss.all, sty.svg__cHqXu)}
          role={"img"}
        />
      }
      navMenuItems={(() => {
    ...
    >
      <LoadingBoundary
        ...
        loadingState={
          <DataCtxReader__>
            {$ctx => (
              <div className={classNames(projectcss.all, sty.freeBox__pPbIb)}>
                <IconIcon
                  className={classNames(projectcss.all, sty.svg__hXcTe)}
                  role={"img"}
                />
              </div>
            )}
      ...
      >
        <DataCtxReader__>
          {$ctx => (
            <div className={classNames(projectcss.all, sty.freeBox__tdAl)}>
              {renderPlasmicSlot({
                defaultContents: (
                  <section
                    className={classNames(projectcss.all, sty.section___19Hrq)}
                  >
                    <h1
                      className={classNames(
                        projectcss.all,
