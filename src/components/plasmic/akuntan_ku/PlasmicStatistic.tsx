...
import sty from "./PlasmicStatistic.module.css"; // plasmic-import: iAriptSG9zeG/css
...
function PlasmicStatistic__RenderFunc(props: {
  ...
  return (
    ...
    >
      {renderPlasmicSlot({
        defaultContents: (
          <div className={classNames(projectcss.all, sty.freeBox__uizWm)}>
            <p
              className={classNames(
                projectcss.all,
                projectcss.p,
            ...
            <PlasmicImg__
              alt={""}
              className={classNames(sty.img__rEswj, {
                [sty.imghideIcon__rEswjTawFr]: hasVariant(
                  $state,
                  "hideIcon",
                  "hideIcon"
                )
      ...
      <Stack__
        as={"div"}
        hasGap={true}
        className={classNames(projectcss.all, sty.freeBox__cso8L)}
      >
        <div
          className={classNames(projectcss.all, sty.freeBox__fMnjM, {
            [sty.freeBoxhideIcon__fMnjMtawFr]: hasVariant(
              $state,
              "hideIcon",
              "hideIcon"
            )
        ...
        <div className={classNames(projectcss.all, sty.freeBox__miaH)}>
          <Stack__
            as={"div"}
            hasGap={true}
            className={classNames(projectcss.all, sty.freeBox__iEdQ4, {
              [sty.freeBoxhideTrendTracker__iEdQ4PD3Q]: hasVariant(
                $state,
                "hideTrendTracker",
                "hideTrendTracker"
              )
          ...
          >
            <div
              className={classNames(projectcss.all, sty.freeBox___1K4Q, {
                [sty.freeBoxhideTrendTracker___1K4QPD3Q]: hasVariant(
                  $state,
                  "hideTrendTracker",
                  "hideTrendTracker"
                )
            ...
            >
              <div className={classNames(projectcss.all, sty.freeBox__aiIgd)}>
                {renderPlasmicSlot({
            ...
            <div className={classNames(projectcss.all, sty.freeBox__okItd)}>
              <div className={classNames(projectcss.all, sty.freeBox__zErWv)}>
                {renderPlasmicSlot({
