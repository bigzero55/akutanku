...
import sty from "./PlasmicDateTimeRangePicker.module.css"; // plasmic-import: _s-_aTbI8-Rx/css
            ...
            <React.Fragment>
              {(() => {
                const child$Props = {
                  ...
                  className: classNames(
                    "__wab_instance",
                    sty.dateTimePicker___9206Y
                  ),
                  picker: "date",
                  popupScopeClassName:
                    sty["dateTimePicker___9206Y__datePickerPopup"],
                  showTime: false
                };
              ...
              {(() => {
                const child$Props = {
                  ...
                  className: classNames(
                    "__wab_instance",
                    sty.dateTimePicker__aarrp
                  ),
                  popupScopeClassName:
                    sty["dateTimePicker__aarrp__datePickerPopup"],
                  showTime: false
                };
